...
3. Add this to the bottom of `conf/local.conf`:
    ...
    # meta-ros deviates from what
    # https://www.yoctoproject.org/docs/2.6.2/mega-manual/mega-manual.html#creating-your-own-distribution states in that DISTRO
    # is not set in this file; instead, it is set in the conf/bblayer.conf generated by mcf to the Distribution setting in the
    # .mcf file.
