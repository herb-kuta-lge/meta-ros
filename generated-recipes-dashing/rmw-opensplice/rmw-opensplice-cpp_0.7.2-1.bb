...
SRC_URI = "https://github.com/ros2-gbp/rmw_opensplice-release/archive/release/dashing/rmw_opensplice_cpp/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "b69e12b1b611b01cba97cdba1220c14d"
SRC_URI[sha256sum] = "79fc0b8a733abfd5e52ef10c7a3e0ebf61b08605b55b87fef87e47b9b4d407ee"
S = "${WORKDIR}/rmw_opensplice-release-release-dashing-rmw_opensplice_cpp-0.7.2-1"
