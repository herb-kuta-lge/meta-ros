...
SRC_URI = "https://github.com/ros2-gbp/geometry2-release/archive/release/dashing/tf2_sensor_msgs/0.11.3-2.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "e97d11aa54e278f9d02c8d0de4e2c666"
SRC_URI[sha256sum] = "e8d330800d955c858eca35471e29523d6aab3e29a5efe994dac0ff109c30060f"
S = "${WORKDIR}/geometry2-release-release-dashing-tf2_sensor_msgs-0.11.3-2"
