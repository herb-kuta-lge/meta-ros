...
SRC_URI = "https://github.com/ros2-gbp/rclcpp-release/archive/release/dashing/rclcpp_components/0.7.6-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "055579bc3156549a34ceec06cdc5d26d"
SRC_URI[sha256sum] = "61c64a881407edb1077a952a1a685667937d2b4ee4d3fb29aa6200eec811c316"
S = "${WORKDIR}/rclcpp-release-release-dashing-rclcpp_components-0.7.6-1"
