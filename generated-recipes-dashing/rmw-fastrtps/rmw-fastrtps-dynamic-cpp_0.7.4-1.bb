...
SRC_URI = "https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/dashing/rmw_fastrtps_dynamic_cpp/0.7.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "4a153dda06f2e37adaf457ab6bdbc558"
SRC_URI[sha256sum] = "0fc77ce1d8dd0cdef07103117147e834214ed1231c764cb126770d8cc48ce22f"
S = "${WORKDIR}/rmw_fastrtps-release-release-dashing-rmw_fastrtps_dynamic_cpp-0.7.4-1"
