...
SRC_URI = "https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/dashing/rmw_fastrtps_shared_cpp/0.7.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "3dbac675ca3aff476f6e0d7fb148f881"
SRC_URI[sha256sum] = "7b0f8c89fc2dc388b40ae4175fe79ee0590c2a412be5e45afdf5a9349880f617"
S = "${WORKDIR}/rmw_fastrtps-release-release-dashing-rmw_fastrtps_shared_cpp-0.7.4-1"
