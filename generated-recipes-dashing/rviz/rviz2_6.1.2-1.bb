...
SRC_URI = "https://github.com/ros2-gbp/rviz-release/archive/release/dashing/rviz2/6.1.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "da4392b6c9a3e29e92753ef96710a3ea"
SRC_URI[sha256sum] = "059d6132a2249c8968fc20f2e9d3ff86a9fc25dff5c3d3a640aee3351d3af26e"
S = "${WORKDIR}/rviz-release-release-dashing-rviz2-6.1.2-1"
