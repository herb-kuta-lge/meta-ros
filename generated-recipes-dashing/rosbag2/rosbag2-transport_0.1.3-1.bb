...
SRC_URI = "https://github.com/ros2-gbp/rosbag2-release/archive/release/dashing/rosbag2_transport/0.1.3-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "27d1d861882db1b6bdae95f36772319f"
SRC_URI[sha256sum] = "cd91705ac6642f8bfb02060be620d4832678ba1f6fd0691ebaa0d41bcbcfc74b"
S = "${WORKDIR}/rosbag2-release-release-dashing-rosbag2_transport-0.1.3-1"
