...
SRC_URI = "https://github.com/ros2-gbp/rosbag2-release/archive/release/dashing/rosbag2_tests/0.1.3-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "10bbd0714e2c96c53c084422c101229d"
SRC_URI[sha256sum] = "1715be58d488d08736e572f99d6fc9db11a89b4af5ba330c072d9a6da9782d76"
S = "${WORKDIR}/rosbag2-release-release-dashing-rosbag2_tests-0.1.3-1"
