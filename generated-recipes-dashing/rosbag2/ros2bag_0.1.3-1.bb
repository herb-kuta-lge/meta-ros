...
SRC_URI = "https://github.com/ros2-gbp/rosbag2-release/archive/release/dashing/ros2bag/0.1.3-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "1f637490331763793df092aff35cfe97"
SRC_URI[sha256sum] = "708ede1d2f975ba5985506a3fa97088668c250fee0b0fa01d6a01c2613bbfadc"
S = "${WORKDIR}/rosbag2-release-release-dashing-ros2bag-0.1.3-1"
