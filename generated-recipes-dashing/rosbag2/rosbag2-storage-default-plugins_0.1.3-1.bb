...
SRC_URI = "https://github.com/ros2-gbp/rosbag2-release/archive/release/dashing/rosbag2_storage_default_plugins/0.1.3-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "2182cf6376a6e7baeeb235fab3cdf0dd"
SRC_URI[sha256sum] = "db121be5b04a9d285b01230e164eaa5b511461502617c980e1f1b73c2d09f856"
S = "${WORKDIR}/rosbag2-release-release-dashing-rosbag2_storage_default_plugins-0.1.3-1"
