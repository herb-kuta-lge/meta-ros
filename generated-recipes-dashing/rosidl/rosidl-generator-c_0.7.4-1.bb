...
SRC_URI = "https://github.com/ros2-gbp/rosidl-release/archive/release/dashing/rosidl_generator_c/0.7.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "069918260923736f77c0d7653eae7f00"
SRC_URI[sha256sum] = "ee1bf4ae254a4a92dbe435bffb3bd1f064c952abe315b410546891a527bf4e6b"
S = "${WORKDIR}/rosidl-release-release-dashing-rosidl_generator_c-0.7.4-1"
