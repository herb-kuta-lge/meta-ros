...
SRC_URI = "https://github.com/PilzDE/pilz_robots-release/archive/release/melodic/pilz_robots/0.5.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "d1ccef08742e1c8668f9964897ffcf8b"
SRC_URI[sha256sum] = "112b5e51c5d1bb5dca76565139813eefb0ecaf7b8d37e54acebf13dc25ffcc2d"
S = "${WORKDIR}/pilz_robots-release-release-melodic-pilz_robots-0.5.4-1"
