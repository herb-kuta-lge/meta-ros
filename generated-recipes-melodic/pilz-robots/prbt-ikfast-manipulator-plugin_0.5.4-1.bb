...
SRC_URI = "https://github.com/PilzDE/pilz_robots-release/archive/release/melodic/prbt_ikfast_manipulator_plugin/0.5.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "61a1506c8b611142615ff02195e9bb24"
SRC_URI[sha256sum] = "2f8ff9a748e068814a745a51d73f2082127407f37600dde87def57f7c69fcc77"
S = "${WORKDIR}/pilz_robots-release-release-melodic-prbt_ikfast_manipulator_plugin-0.5.4-1"
