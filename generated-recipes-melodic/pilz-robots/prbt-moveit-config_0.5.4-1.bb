...
SRC_URI = "https://github.com/PilzDE/pilz_robots-release/archive/release/melodic/prbt_moveit_config/0.5.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "9ca0b211f997765d1f1944ac4be78b2b"
SRC_URI[sha256sum] = "07ea7e31ccf0a5598cdae69416eb8466de880588220a2376a3fc9af41c05f323"
S = "${WORKDIR}/pilz_robots-release-release-melodic-prbt_moveit_config-0.5.4-1"
