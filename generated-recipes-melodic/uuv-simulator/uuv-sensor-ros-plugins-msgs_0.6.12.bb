...
SRC_URI = "https://github.com/uuvsimulator/uuv_simulator-release/archive/release/melodic/uuv_sensor_ros_plugins_msgs/0.6.12-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
