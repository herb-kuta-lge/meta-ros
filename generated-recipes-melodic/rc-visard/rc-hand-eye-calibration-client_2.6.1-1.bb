...
SRC_URI = "https://github.com/roboception-gbp/rc_visard-release/archive/release/melodic/rc_hand_eye_calibration_client/2.6.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "8f9b4354a77b2d79b18568285f2f1589"
SRC_URI[sha256sum] = "0d2285e1ba53331c29d1e87fee1ac51cd77d19d61b23608e2489112bf60084f9"
S = "${WORKDIR}/rc_visard-release-release-melodic-rc_hand_eye_calibration_client-2.6.1-1"
