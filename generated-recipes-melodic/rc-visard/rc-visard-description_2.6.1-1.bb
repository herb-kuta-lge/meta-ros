...
SRC_URI = "https://github.com/roboception-gbp/rc_visard-release/archive/release/melodic/rc_visard_description/2.6.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "afb4d60c9d328fb3c79d334480a8b078"
SRC_URI[sha256sum] = "b1e3e7ff112970d8e184186da04ae171dd473e119c99239f48a3f6423fa69d54"
S = "${WORKDIR}/rc_visard-release-release-melodic-rc_visard_description-2.6.1-1"
