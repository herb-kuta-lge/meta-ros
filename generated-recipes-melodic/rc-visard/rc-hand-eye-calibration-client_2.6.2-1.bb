...
SRC_URI = "https://github.com/roboception-gbp/rc_visard-release/archive/release/melodic/rc_hand_eye_calibration_client/2.6.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "f357f64a9ee291900c7be75ea64abdf2"
SRC_URI[sha256sum] = "dafca9dc8455b02a89f03d03dadc6f5cc5ffefb9692934bacd0f11901b5de6da"
S = "${WORKDIR}/rc_visard-release-release-melodic-rc_hand_eye_calibration_client-2.6.2-1"
