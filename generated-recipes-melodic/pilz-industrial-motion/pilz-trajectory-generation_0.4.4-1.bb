...
SRC_URI = "https://github.com/PilzDE/pilz_industrial_motion-release/archive/release/melodic/pilz_trajectory_generation/0.4.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
