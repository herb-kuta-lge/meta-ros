...
SRC_URI = "https://github.com/pr2-gbp/pr2_controllers-release/archive/release/melodic/single_joint_position_action/1.10.16-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "e577a90dcebd2291d7041e4a75a33819"
SRC_URI[sha256sum] = "54ae567edc0ffc8c8be49d337b28f44b3aeec65d5d91b60350b03bd5bb97a0c9"
S = "${WORKDIR}/pr2_controllers-release-release-melodic-single_joint_position_action-1.10.16-1"
