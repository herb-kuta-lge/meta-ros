...
SRC_URI = "https://github.com/pr2-gbp/pr2_controllers-release/archive/release/melodic/ethercat_trigger_controllers/1.10.16-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "dff0e9642062dfe975644f72f11e3dc1"
SRC_URI[sha256sum] = "21fc3e32b3271214067e176ae863a773351d94d81448c650b40f7976f057e4f9"
S = "${WORKDIR}/pr2_controllers-release-release-melodic-ethercat_trigger_controllers-1.10.16-1"
