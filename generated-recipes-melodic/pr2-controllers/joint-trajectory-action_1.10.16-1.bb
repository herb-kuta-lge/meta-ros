...
SRC_URI = "https://github.com/pr2-gbp/pr2_controllers-release/archive/release/melodic/joint_trajectory_action/1.10.16-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "d33bc717dc3913336b1febab3d80fb24"
SRC_URI[sha256sum] = "9c8bb4ea9533d5003a1df77e95db20e54e487dad442c457c6e8e89ba6d5ae1a4"
S = "${WORKDIR}/pr2_controllers-release-release-melodic-joint_trajectory_action-1.10.16-1"
