...
SRC_URI = "https://github.com/pr2-gbp/pr2_controllers-release/archive/release/melodic/pr2_controllers_msgs/1.10.16-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "739f5b6da1e1ef6597d85768f0b53707"
SRC_URI[sha256sum] = "7df6fb2f4a1fcb88af85dcd992d6864120a383811493157e7624a724474fb95c"
S = "${WORKDIR}/pr2_controllers-release-release-melodic-pr2_controllers_msgs-1.10.16-1"
