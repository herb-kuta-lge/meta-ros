...
SRC_URI = "https://github.com/mavlink/mavros-release/archive/release/melodic/test_mavros/0.32.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "bd1df02870c1facc7ed284d7a8da0044"
SRC_URI[sha256sum] = "380ed6eb43b87e9a2fe868f1e3ce042847bf144dc19b214c964481a44ce94eaf"
S = "${WORKDIR}/mavros-release-release-melodic-test_mavros-0.32.0-1"
